...
public class HQPropertiesConverter {
   ...
   private static Map<SimpleString, SimpleString> mixedDictionary;
   ...
   static {
      ...
      d = new HashMap<>();
      d.putAll(hqAmqDictionary);
      d.putAll(amqHqDictionary);
      mixedDictionary = Collections.unmodifiableMap(d);
   ...
   public static void replaceEitherProperties(final Message message) {
      replaceDict(message, amqHqDictionary);
   }

   public static void replaceHQProperties(final Message message) {
      replaceDict(message, mixedDictionary);
   }

   public static void replaceDict(final Message message, Map<SimpleString, SimpleString> dictionary) {
