...
public class HornetQClientProtocolManagerFactory implements ClientProtocolManagerFactory {
   ...
   public void setLocator(ServerLocator locator) {
      ...
      locator.addIncomingInterceptor(new HQPropertiesIncomingInterceptor());
      locator.addOutgoingInterceptor(new HQPropertiesOutgoingInterceptor());
   }

   @Override
   public ClientProtocolManager newProtocolManager() {
      System.out.println("Instantiating a new Protocol Manager for HornetQ");
